...
void menu() {
    ...
    do {
        ...
        case 5: {
            ...
            struct Data data; // 
            cout << "Введите название товара: "; cin >> data.name; // вводим в поле данных
            cout << "Введите стоимость: "; cin >> data.cost; // вводим в поле данных
            cout << "Введите количество: "; cin >> data.quantity; // вводим в поле данных
            cout << "Введите наличие: "; cin >> data.availability; // вводим в поле данных
        ...
        case 7: {
            ...
            printTree(root); // вывод корня (печать товаров)
